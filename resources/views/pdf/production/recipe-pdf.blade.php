        ...
        <table class="table-condensed table">
            <tbody class="">
                <tr class="border">
                    ...
                    <td class="text-righ t border">{{ $recipe->recipe_number }}</td>
                </tr>
                <tr>
                    <th class="border">Production Article</th>
                    <td class="border text-right">
                        <span style="font-weight: bolder">{{ $recipe->productionArticle->display_name }}</span>
                    </td>
                </tr>
            </tbody>
        </table>
...
<div class="row">
    <div class="col-8"></div>
    <div class="col-4">
        <table class="table-borderless table" style="border-top: 1px solid black !important">
            <tr class="border-top" style="border-bottom: double">
                <th>Total Cost:</th>
                <th class="bold text-right">{{ number_format($grand_total, 2) }}</th>
            </tr>
        </table>
    </div>
</div>
