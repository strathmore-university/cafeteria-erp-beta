            ...
            <tbody class="">
                ...
                <tr>
                    ...
                    <td class="border text-right">
                        <span style="font-weight: bolder">{{ $invoice->supplier->name }}</span>
                    </td>
                </tr>
            </tbody>
        </table>
...
<div class="row">
    ...
    <div class="col-4">
        <table class="table-borderless table" style="border-top: double !important">
            <tr class="mb-0 p-0">
                <th>Net Total:</th>
                <th class="bold text-right">{{ number_format($net_total, 2) }}</th>
            </tr>
            <tr class="mb-0 p-0">
                <th>V.A.T Total:</th>
                <th class="bold text-right">{{ number_format($vat_total, 2) }}</th>
            </tr>
