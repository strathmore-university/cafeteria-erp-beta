...
<table class="w-100 table-borderless border p-2">
    <tr>
...
<table class="w-100 table-condensed">
    <tbody>
        ...
        @foreach ($purchaseOrder->items as $item)
            <tr class="border-bottom m-0 p-0">
...
<div class="mb-5" style="border-bottom: double !important">
    <table class="table-borderless table">
        <tr style="border-top: 1px solid black">
            <th>Total Amount:</th>
            <th class="bold text-right">KES {{ number_format($purchaseOrder->total_value, 2) }}</th>
        </tr>
    </table>
</div>
...
<div class="border p-2">
    ...
    <ol>
        <li>
            ...
            <b>{{ \Carbon\Carbon::parse($purchaseOrder->expires_at)->isoFormat(' dddd Do MMMM, Y') }}</b>
        </li>
    ...
    <p class="h5 font-weight-bolder">This LPO has been electronically approved, therefore substitutes signatures.</p>
        ...
        <tr>
            ...
            <td class="text-right">
                <dl>
                    ...
                    <dd>
                        {{ \Carbon\Carbon::parse($purchaseOrder->expected_delivery_date)->isoFormat('dddd Do MMMM, Y') }}
                    </dd>
                </dl>
            </td>
        </tr>
