    ...
    public function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Select::make('article_id')
                ->label('By product')->preload()->searchable()
                ->reactive()->options(Article::whereIsProduct(true)->whereNotIn('id', [$this->ownerRecord->article_id])->isDescendant()->pluck('name', 'id')->toArray())
